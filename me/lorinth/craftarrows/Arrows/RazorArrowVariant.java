...
public class RazorArrowVariant extends ArrowVariant{
    ...
    public RazorArrowVariant(FileConfiguration config){
        super(config, ConfigPaths.Recipes + ".", ArrowNames.Razor, new ArrayList<ConfigValue>(){{
            add(new ConfigValue(ConfigPaths.Recipes + "." + ArrowNames.Razor + ".BonusDamage", 4.0));
        }});
    }
    ...
    protected void loadDetails(FileConfiguration config) {
        ...
        extraDamage = Convert.Convert(Double.class, configValues.get(0).getValue(config));
    }

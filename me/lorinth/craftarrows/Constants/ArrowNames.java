...
public class ArrowNames {
    ...
    public static final String Cooling = "Cooling"; //Lava to obsidian
    ...
    public static final String Homing = "Homing"; //Homes in on target
    public static final String Ice = "Ice";
    public static final String Lightning = "Lightning";
    public static final String Medic = "Medic";
    public static final String Multishot = "Multishot"; //Fires a number of arrows in quick succession
    ...
    public static final String Volley = "Volley"; //Fires a volley of arrows
